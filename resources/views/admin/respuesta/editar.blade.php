...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-info">
            ...
            <form action="{{route('Respuesta.actualizar', $item->id)}}" method="POST">
                @method('PUT') 
                @csrf
                @error('item')
                ...
                <div class="box-body">
                    <div class="form-group">
                            <h4>Solución</h4>      
                            <input id="solucion" name="solucion" class="form-control" type="text" value="{{$item->solucion}}">
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-6">  
                            ...
                            <select name="estado" id="estado" class="form-control selected">
                                ...
                                <option value="regular">Regular(4 a 6)</option>
